...
const AbooutPage = () => {
  return (
    <>
      {/* ── HERO ── */}
      <section className="bg-[#fdf0f3] px-8 md:px-16 lg:px-24 pt-36 pb-16 flex flex-col items-center text-center">
        <p className="text-[10px] font-semibold tracking-[0.28em] uppercase text-[#b5345a] mb-5">
          Our Story
        </p>
        <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl text-[#1e0e14] font-normal leading-tight">
      ...
      {/* ── STORY ── */}
      <section className="bg-[#fdf0f3] px-8 md:px-16 lg:px-24 py-20 flex flex-col md:flex-row items-center gap-14">
        <div
          className="shrink-0 w-full md:w-85 min-h-120 rounded-3xl relative overflow-hidden shadow-xl"
          style={{
            background:
        ...
        <div className="flex-1 max-w-xl">
          <h2 className="font-serif text-4xl md:text-5xl text-[#1e0e14] font-normal leading-tight mb-2">
            A studio built on
          </h2>
          <h2 className="font-serif text-4xl md:text-5xl italic text-[#b5345a] leading-tight mb-6">
            real skin, real love
          </h2>
          ...
          <p className="text-[#4a3038] text-base leading-relaxed mb-5">
          ...
          <p className="text-[#4a3038] text-base leading-relaxed">
      ...
      {/* ── VALUES ── */}
      <section className="bg-[#fdf0f3] px-8 md:px-16 lg:px-24 py-20">
        <div className="mb-12">
          <p className="text-[10px] font-semibold tracking-[0.28em] uppercase text-[#b5345a] mb-4">
            Our Foundation
          </p>
          <h2 className="font-serif text-4xl md:text-5xl text-[#1e0e14] font-normal mb-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {values.map(function (v, i) {
            ...
            return (
              <div
                key={i}
                className={`rounded-2xl p-7 flex flex-col gap-4 bg-white shadow-sm transition-shadow duration-300 hover:shadow-md ${
      ...
      <section className="bg-[#fdf0f3] px-8 md:px-16 lg:px-24 py-20">
        ...
        <div className="flex justify-center">
          <div className="bg-white rounded-3xl shadow-sm border border-[#f0dde6] p-10 flex flex-col items-center text-center max-w-sm w-full">
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl">
          <p className="text-white/50 text-[10px] font-semibold tracking-[0.3em] uppercase mb-7">
            Our Mission
          </p>
          <p className="font-serif italic text-white text-2xl md:text-3xl lg:text-4xl leading-relaxed">
          ...
          <p className="text-white/40 text-[10px] font-semibold tracking-[0.25em] uppercase mt-8">
