  ...
  return (
    <>
      ...
      <header className="fixed top-6 left-1/2 -translate-x-1/2 w-[95%] max-w-6xl z-50">
        <nav className="relative flex items-center justify-between px-6 py-3 bg-white/30 backdrop-blur-lg border border-white/40 rounded-full shadow-sm transition-all duration-300">
          {/* Logo */}
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link to="/" className="text-gray-800 text-sm font-medium tracking-wide hover:text-[#B04A6B] transition-colors">
              Home
            </Link>
            <Link to="/about" className="text-gray-800 text-sm font-medium tracking-wide hover:text-[#B04A6B] transition-colors">
              About Us
            </Link>
            <Link to="/services" className="text-gray-800 text-sm font-medium tracking-wide hover:text-[#B04A6B] transition-colors">
              Services
            </Link>
            <Link to="/booking">
        ...
        {isMobileMenuOpen && (
          <div className="absolute top-[120%] left-0 w-full bg-white/90 backdrop-blur-xl border border-white/50 shadow-xl rounded-2xl p-6 flex flex-col items-center space-y-6 md:hidden animate-in fade-in slide-in-from-top-4 duration-300">
            <Link to="/" className="text-gray-800 text-lg font-medium hover:text-[#B04A6B] transition-colors" onClick={closeMenu}>
              Home
            </Link>
            <Link to="/about" className="text-gray-800 text-lg font-medium hover:text-[#B04A6B] transition-colors" onClick={closeMenu}>
              About Us
            </Link>
            <Link to="/services" className="text-gray-800 text-lg font-medium hover:text-[#B04A6B] transition-colors" onClick={closeMenu}>
              Services
            </Link>
